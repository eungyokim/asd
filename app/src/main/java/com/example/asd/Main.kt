...
import com.example.asd.databinding.CalendarBinding.inflate
import com.example.asd.databinding.FindIdBinding.inflate
...
class Main : AppCompatActivity(),  NfcAdapter.ReaderCallback{
    ...
    private fun startProcess() {
        ...
        findViewById<ImageButton>(R.id.main_help).setOnClickListener{
            ...
            builder.setTitle("ASD 사용설명서")
            builder.setItems(asdHelpArray, object : DialogInterface.OnClickListener{
                override fun onClick(dialog: DialogInterface, which: Int) {
                    val builder1 = AlertDialog.Builder(this@Main)
                    val helpLed = layoutInflater.inflate(R.layout.help_led, null)
                    if (which == 0) {
                        builder1.setView(helpLed)
                        builder1.setPositiveButton("확인", DialogInterface.OnClickListener { dialog, which ->
