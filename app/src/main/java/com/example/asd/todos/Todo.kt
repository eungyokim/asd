...
@Entity
data class Todo(var text: String?,var today: String?, var tyear: Int?, var tmonth: Int?,var tdate: Int?,var thisColor: String?, var tindex: String?, var isDone: Boolean = false) : Serializable {
